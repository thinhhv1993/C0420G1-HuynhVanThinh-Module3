...
<div class="col-sm-12">
    <a href="/furamas?action=createContractDetail" class="btn btn-secondary"> <span>Add New Contract Detail</span></a>
</div>
<table class="table table-striped table-hover">
    ...
    <c:forEach var="contractDetail" items="${contractDetailList}">
        <tr>
            <td><a href="/furamas?action=editContractDetail&contractDetailId=${contractDetail.contractDetailId}">
                <c:out value="${contractDetail.contractDetailId}"/></a></td>
            <td><c:out value="${contractDetail.contractId}"/></td>
            <td><c:out value="${contractDetail.attachServiceName}"/></td>
            <td><c:out value="${contractDetail.quantity}"/></td>
            <td>
                <a href="/furamas?action=editContractDetail&contractDetailId=${contractDetail.contractDetailId}" class="settings" title="Settings"
                   data-toggle="tooltip"><i class="fas fa-edit"></i></a>
                <a href="/furamas?action=deleteContractDetail&contractDetailId=${contractDetail.contractDetailId}" class="delete" title="Delete"
