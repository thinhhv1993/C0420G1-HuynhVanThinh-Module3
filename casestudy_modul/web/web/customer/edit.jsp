                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select name="customerTypeId" id="customerTypeId" >
                                        <option ${customer.customerTypeName == 'Diamond' ? 'selected' : ''} value="1">Diamond</option>
                                        <option ${customer.customerTypeName == 'Platinium' ? 'selected' : ''} value="2">Platinium</option>
                                        <option ${customer.customerTypeName == 'Gold' ? 'selected' : ''} value="3">Gold</option>
                                        <option ${customer.customerTypeName == 'Silver' ? 'selected' : ''} value="4">Silver</option>
                                        <option ${customer.customerTypeName == 'Member' ? 'selected' : ''} value="5">Member</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="customerBirthday" name="customerBirthday" value="<c:out value='${customer.customerBirth}' />">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select name="customerGender" id="customerGender" >
                                        <option  ${customer.customerGender == 'Nam' ? 'selected' : ''} value="Nam">Nam</option>
                                        <option  ${customer.customerGender == 'Nữ' ? 'selected' : ''} value="Nữ">Nữ</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="customerIdCard" name="customerIdCard" value="<c:out value='${customer.customerIdCard}' />">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="customerPhone" name="customerPhone" value="<c:out value='${customer.customerPhone}' />">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="customerEmail" name="customerEmail" value="<c:out value='${customer.customerEmail}' />">
                                </div>
                            </div>
                        </div>
                        <div class="row">
