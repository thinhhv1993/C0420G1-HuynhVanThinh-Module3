        ...
        <div class="row">
            <div class="col-md-8 mx-auto">
                <div class="contact-form">
                    <h1>Insert Contract</h1>
                    <form action="/furamas?action=createContract" method="post">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select name="customerId" id="customerId" >
                                        ...
                                        <option value="<c:out value="${customer.customerId}"/>"><c:out value="${customer.customerId}"/><c:out value="${customer.customerName}"/></option>
                                        </c:forEach>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="contractStarDate" name="contractStarDate">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="contractDeposit" name="contractDeposit">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="contractTotalMoney" name="contractTotalMoney">
                                </div>
                            </div>
                        </div>
